      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-primary-400 mb-4">BookStore</h3>
            <p className="text-gray-300 mb-4">
              Your one-stop destination for all your favorite books. Discover new worlds, 
              explore different genres, and find your next great read.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/books" className="text-gray-300 hover:text-primary-400">
                  Browse Books
                </Link>
              </li>
              <li>
